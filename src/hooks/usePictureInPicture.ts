...
export const usePictureInPicture = () => {
    ...
    const togglePiP = useCallback(async () => {
        ...
        // Check API support
        // @ts-expect-error - PictureInPicture API is not fully typed despite check - documentPictureInPicture is not yet in standard TS types
        ...
        try {
            // @ts-expect-error - PictureInPicture API is not fully typed despite check
