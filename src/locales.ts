  ...
  pt: {
    ...
    landing: {
      hero: {
        ...
        subheadline: "O Teleprompter profissional com latência zero e controle remoto via celular. Sem cabos, sem apps, direto no navegador.",
        cta: "Lançar Web App"
      },
      features: {
        sync: {
    ...
    host: {
      ...
      paywall: {
        ...
        desc: "Esta funcionalidade é exclusiva para Ninjas PRO. Desbloqueie para usar cores, voz e limite ilimitado.",
  ...
  en: {
    ...
    landing: {
      hero: {
        ...
        subheadline: "The professional zero-latency teleprompter with remote control. No cables, no apps, runs in your browser.",
        cta: "Launch Web App"
      },
      features: {
        sync: {
