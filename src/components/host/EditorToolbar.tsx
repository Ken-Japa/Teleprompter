    ...
    return (
        <S.FormattingToolbar>
            <div className="flex items-center">
                ...
                <div className="flex space-x-1 bg-slate-800/50 p-1 rounded-lg border border-slate-700/50" role="group" aria-label="Text Highlights">
            ...
            <S.IconButton onClick={onClear} className="hover:text-red-400" aria-label="Clear All Text" title="Clear All Text">
