    ...
    return (
        <S.FormattingToolbar>
            <div className="flex items-center">
                <span className="hidden sm:inline text-[10px] uppercase font-bold text-slate-500 mr-3 tracking-wider">{t("host.editor.highlight")}</span>
                <div
                    className="flex space-x-1.5 bg-white/5 p-1.5 rounded-xl border border-white/5 shrink-0"
                    role="group"
