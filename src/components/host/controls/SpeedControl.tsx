...
export const SpeedControl = memo(({ isPlaying, speed, onStateChange, onReset }: SpeedControlProps) => {
    ...
    return (
        <S.HudGroup >
            <S.IconButton onClick={onReset} title={t("host.controls.reset")} aria-label={t("host.controls.reset")} className="w-8 h-8 sm:w-10 sm:h-10">
