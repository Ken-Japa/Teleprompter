...
>(({ className = "", ...props }, ref) => (
    <textarea
        ...
        name="scriptText"
        className={`flex-1 min-h-[500px] bg-transparent p-8 lg:p-16 pb-16 focus:pb-[45vh] focus:scroll-pb-[45vh] text-lg lg:text-2xl font-sans text-slate-200 resize-none focus:outline-none focus:ring-0 scrollbar-thin scrollbar-thumb-slate-800 placeholder:text-slate-700 leading-[1.8] max-w-7xl mx-auto w-full relative z-10 selection:bg-brand-500/30 tracking-wide transition-all duration-300 ${className}`}
...
export const ControlsContainer = ({ children }: { children: React.ReactNode }) => (
    <div className="flex-none bg-slate-950/90 backdrop-blur-3xl p-6 pb-12 rounded-t-[3rem] shadow-[0_-10px_60px_rgba(0,0,0,0.6)] border-t border-white/10 space-y-6 z-20 relative ring-1 ring-white/5 overflow-hidden">
