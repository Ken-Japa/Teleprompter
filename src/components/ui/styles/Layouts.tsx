...
export const QRCodeBox = ({ children, hasId }: { children: React.ReactNode; hasId: boolean }) => (
    ...
    >
        <div className="bg-slate-950 p-2 sm:p-3 rounded-[22px] relative z-10 w-full h-full flex items-center justify-center">
            <div className="bg-white p-3 sm:p-4 rounded-xl shadow-inner w-full h-full flex items-center justify-center">{children}</div>
        </div>
    </div>
);
