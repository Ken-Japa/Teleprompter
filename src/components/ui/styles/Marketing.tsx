 ...
 <div className="relative p-[1px] rounded-[3rem] overflow-hidden bg-gradient-to-b from-indigo-500 via-purple-500 to-pink-500 shadow-[0_0_100px_-20px_rgba(99,102,241,0.3)] max-w-sm w-full mx-auto transform hover:scale-[1.02] transition-transform duration-500 group">
  <div className="bg-[#050914] p-10 rounded-[47px] relative h-full flex flex-col items-center text-center">
   ...
   <div className="relative z-10 w-full flex flex-col items-center">
    ...
    <div className="text-7xl font-display font-black text-white mb-2 tracking-tighter drop-shadow-2xl">
     {price}
    </div>
    ...
    <button
     onClick={onClick}
     className="w-full py-4 bg-white text-slate-950 font-bold text-lg rounded-2xl hover:bg-indigo-50 transition-all shadow-lg shadow-white/10 hover:shadow-white/20 active:scale-95 duration-200 flex items-center justify-center tracking-tight"
    >
     {subtitle}
    </button>
   </div>
