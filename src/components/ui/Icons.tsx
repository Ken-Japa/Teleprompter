...
export const PiPIcon = ({ className }: { className?: string }) => (
    ...
    >
        ...
        <rect x="12" y="11" width="8" height="6" rx="1" ry="1" fill="currentColor" fillOpacity="0.2" />
    </svg>
);
...
export const FlipIcon = ({ className }: { className?: string }) => (
    <svg
        ...
        className={className}
    >
        <path d="M8 5l-5 7 5 7M16 5l5 7-5 7M12 5v14"></path>
    </svg>
);
...
export const NavIcon = ({ className }: { className?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const GoogleIcon = ({ className }: { className?: string }) => (
    <svg
        ...
        className={className}
    >
        <path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .533 5.333.533 12S5.867 24 12.48 24c3.44 0 6.1-1.12 7.96-3.067 1.947-1.933 2.56-4.693 2.56-6.933 0-.68-.053-1.333-.147-1.973H12.48z" />
    </svg>
);
...
export const OBSIcon = ({ className }: { className?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
