export const en = {
  ...
  landing: {
    ...
    hero: {
      headline: "Free Online Autocue. Record looking at the camera, without getting stuck on the text.",
      subheadline:
        "The text scrolls at your pace. Control with your phone or by voice. No apps, no hassle.",
      ...
      smallphrase: "No signup • Works right in your browser • Offline after install",
      p2pSection: {
    ...
    problemSolution: {
      ...
      before: {
        title: "Before",
        items: [
          "😩 Forgetting the script midway and having to re-record everything",
          "😤 Wasting hours pausing and adjusting the script manually",
          "🤬 Trying DIY solutions that just don't work properly",
          "🏃 Got up 15 times to pause/continue text",
          "💸 Spending money on apps or gear that lag or complicate things",
          "📱 Downloading apps full of logins, ads, or delays",
        ],
      },
      after: {
        title: "Now",
        items: [
          "🎯 Speak looking straight at the camera, naturally",
          "📱 Control play, pause, and speed from your phone (zero delay)",
          "🗣️ The text follows your voice automatically",
          "🔒 Everything private: your scripts stay only on your device",
          "🌍 Works offline, anywhere (even without internet)",
          "⏱️ Record more videos faster, without re-recording",
        ],
      },
    },
    howItWorks: {
    ...
    features: {
      ...
      obs: {
        ...
        desc: "Connect directly to OBS via WebSocket. Automate your recordings and switch scenes natively without leaving the teleprompter.",
      },
      themes: {
        title: "Visual Themes",
...
Aligned perfectly`,
    ...
    controls: {
      ...
      livePreviewHelp: "Modify to preview",
    },
    hudLabels: {
      theme: "Theme",
      focus: "Focus",
    ...
    paywall: {
      ...
      deviceLimit: "Device limit reached (12 devices). If you changed devices or formatted your PC, contact support to reset your access.",
      notFound: "Key not found. Check if you typed it correctly or check your Kiwify email (including spam).",
    ...
    autocomplete: {
      ...
      suggestions: {
        ...
        loop_end: { label: "LOOP END", desc: "End loop with X iterations (Ex: [LOOP 5])" },
...
Paste your script here and customize your experience to start shining!`,
  ...
  script: {
    ...
    trash: "Trash",
    emptyTrash: "Your trash is empty",
    restore: "Restore",
    permanentlyDelete: "Permanently Delete",
    autoCleanupNote: "Scripts are automatically deleted after 14 days",
  },
  footer: {
  ...
  editor: {
    ...
    find: "Find",
    findPlaceholder: "Type the text to search...",
    replacePlaceholder: "Type the text to replace...",
  ...
  hotkeys: {
    ...
    actions: {
      ...
      FORMAT_RED: "Color: Red",
      FORMAT_YELLOW: "Color: Yellow",
      FORMAT_GREEN: "Color: Green",
      FORMAT_BLUE: "Color: Blue",
    },
  },
  voice_analytics: {
    title: "Presentation Finished",
    congratulations: "Amazing! You finished the script.",
    subtitle: "Here's the summary of your performance in this session:",
    duration: "Duration",
    wpm: "WPM (Speed)",
    accuracy: "Accuracy",
    sentences: "Sentences",
  ...
  midi: {
    ...
    actions: {
      TOGGLE_PLAY: "Play / Pause",
      NEXT_SONG: "Next Song / Part",
      PREV_SONG: "Previous Song / Part",
    ...
    proDescription: "Connecting MIDI pedals and OBS Studio is exclusive for PRO members.",
  },
  ...
  obs: {
    ...
    port: "Port",
    password: "Password",
    automation: "Ninja Automation",
    autoRecord: "Record on OBS when Play",
    autoPlay: "Play when Record on OBS",
    errorConnection: "Failed to connect. Check if OBS WebSocket (v5) is enabled.",
  },
  onboarding: {
