...
export const SeoPages = {
    ...
    TeleprompterModoMusico: React.lazy(() =>
        import("../pages/seo/TeleprompterModoMusico").then((module) => ({
    ...
    TeleprompterModoBilingue: React.lazy(() =>
        import("../pages/seo/TeleprompterModoBilingue").then((module) => ({
            default: module.TeleprompterModoBilingue,
        }))
    ),
    TeleprompterFitness: React.lazy(() =>
        import("../pages/seo/TeleprompterFitness").then((module) => ({
