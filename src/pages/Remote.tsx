...
export const Remote: React.FC<RemoteProps> = ({ hostId }) => {
 ...
 const { status, isPlaying, speed, progress } = state;
      ...
      <S.ControlsContainer>
       <div className="flex items-center justify-between px-6 pb-safe gap-6">
        ...
        <button
         ...
         className={`flex-1 h-44 rounded-[2.5rem] shadow-2xl transition-all duration-300 active:scale-95 border-t border-white/10 flex flex-col items-center justify-center gap-3 relative overflow-hidden group ${
          isPlaying
