export const ComoUsarTeleprompterES = () => (
    <>
        ...
        <p className="lead text-xl text-slate-300 mb-8">
            Grabar vídeos puede ser una pesadilla. Tienes un guion increíble, pero a la hora de hablar frente a la cámara, las palabras se desvanecen. Tartamudeas, olvidas puntos clave y terminas con docenas de tomas, perdiendo horas en la edición. Si esto te suena familiar, un teleprompter no es un lujo, es una necesidad.
        </p>

        <div className="bg-slate-900 p-6 rounded-lg border border-slate-800 mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">El Problema Central: La Carga Cognitiva de la Memorización</h2>
            <p className="text-slate-300">
                El cerebro humano no está optimizado para hacer dos cosas complejas a la vez: recordar un texto palabra por palabra y presentarlo de forma carismática y natural. Por eso, los actores de televisión, presentadores de noticias y hasta los presidentes usan teleprompters. Liberan la mente de la tarea de memorizar, permitiendo que toda la energía se concentre en la actuación, la entonación y la conexión con la audiencia. Intentar hacerlo todo "de memoria" es la receta para un vídeo robótico y sin vida.
            </p>
        </div>
