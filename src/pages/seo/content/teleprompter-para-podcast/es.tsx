...
export const TeleprompterParaPodcastES = () => (
    <>
        ...
        <SEOImage
            ...
            alt="Podcast grabado con teleprompter"
            caption="El teleprompter garantiza que el presentador mantenga el contacto visual con los invitados mientras sigue el guion."
            width={1200}
            height={675}
            priority={true}
        />
