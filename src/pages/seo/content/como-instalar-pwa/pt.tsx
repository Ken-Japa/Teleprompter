...
export const ComoInstalarPwaPT = () => (
    <>
        <h1 className="text-4xl font-bold text-white mb-6 leading-tight">Como "Baixar" o PromptNinja (Instalar App PWA)</h1>
        ...
        <div className="bg-gradient-to-r from-purple-900/40 to-blue-900/40 p-8 rounded-xl border border-purple-500/30 mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Por que instalar assim é melhor?</h2>
        ...
        <h2 className="text-3xl font-bold text-white mb-8">Guia de Instalação Passo a Passo</h2>
